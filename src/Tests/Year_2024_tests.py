...
def Day23_test():
    ...
    assert v1==7, day_label+", Part 1 Failed, Input: "+fname
    assert v2=='co,de,ka,ta', day_label+", Part 2 Failed, Input: "+fname

    fname = 'Input02.txt'
    v1, v2 = current_day.solution(show_result=False, fname=fname)

    assert v1==1200, day_label+", Part 1 Failed, Input: "+fname
    assert v2=='ag,gh,hh,iv,jx,nq,oc,qm,rb,sm,vm,wu,zr', day_label+", Part 2 Failed, Input: "+fname
